...
class VGNImplicit(object):
    def __init__(self, model_path, model_type, best=False, force_detection=False, qual_th=0.9, out_th=0.5, visualize=False, resolution=40, **kwargs):
        ...
        #https://www.cnblogs.com/Brisling/p/17066790.html
        ...
        self.pos = pos.view(1, self.resolution * self.resolution * self.resolution, 3)  #https://blog.csdn.net/york1996/article/details/81949843
...
def predict(tsdf_vol, pos, net, device):
    ...
    # model_graph = draw_graph(net, input_data=(tsdf_vol, pos),depth=7, graph_name='GIGA', roll=True,expand_nested=True,save_graph=True,filename="GIGA_fig_test")
