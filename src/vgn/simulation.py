...
class ClutterRemovalSim_bolt(object):
    def __init__(self, scene, object_set, gui=True, seed=None):
        ...
        self.gripper = Gripper_bolt(self.world)
        self.size = 6 * self.gripper.finger_depth
        intrinsic = CameraIntrinsic(640, 480, 606.77737126, 606.70030146, 321.63287183, 236.95293136)
    ...
    def discover_objects(self):
        ...
        self.object_urdfs = [f for f in root.iterdir() if f.suffix == ".urdf" ]  #新增物體
...
class Gripper_bolt(object):
    ...
    def __init__(self, world):
        ...
        self.max_opening_width = 0.06  #改寬度
